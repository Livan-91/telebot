...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://telegra.ph/file/2d63e68b8c4ef10928d20.png" type="image/jpg">
    <script
...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      <div class="brand">
        <img
          src="https://telegra.ph/file/2d63e68b8c4ef10928d20.png"
          alt="logo"
        />
        <a href="https://t.me/heavens_arena">
          <h2 class="name">Qbittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://www.github.com/rajput-hemant/telegram-mirror-bot"><i class="fab fa-github"></i></a>
        <a href="https://t.me/heavens_arena"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
...
@app.route('/')
def homepage():
    return "<h1>Heavens Arena EDU Mirror Group <a href='https://t.me/heavens_arena'>@GitHub</a> By <a href='https://github.com/rajput-hemant'>rajput-hemant</a></h1>"
